...
export default function ChatPage() {
  ...
  const [activeTab, setActiveTab] = useState<
    "conversations" | "requests" | "pending"
  >("conversations");
              ...
              {activeTab === "conversations" && (
                <>
                  ...
                  {conversations.length === 0 ? (
                    <p className="px-6 py-6 text-gray-500 dark:text-gray-400 text-center">
                      אין שיחות פעילות. שלח בקשת צ\'אט מפרופיל של משתמש.
                    </p>
                  ) : (
                        ...
                        <li key={c.id}>
                          ...
                          >
                            <UserAvatar
                              ...
                              size="lg"
                              isOnline={isOnline(
                                presenceMap[c.otherUser.id] ??
                                  c.otherUser.lastSeenAt,
                              )}
                            />
                        ...
                        >
                          ...
                          >
                            <UserAvatar
                              ...
                              size="lg"
                              isOnline={isOnline(
                                presenceMap[r.sender.id] ?? r.sender.lastSeenAt,
                              )}
                            />
                          </Link>
                          <div className="flex-1 min-w-0">
                        ...
                        <li key={r.id}>
                          ...
                          >
                            <UserAvatar
                              ...
                              size="lg"
                              isOnline={isOnline(
                                presenceMap[r.receiver.id] ??
                                  r.receiver.lastSeenAt,
                              )}
                            />
                            <div className="flex-1 min-w-0">
                              <p className="font-medium text-gray-800 dark:text-gray-100 truncate">
                                {r.receiver.full_name || r.receiver.username}
                              </p>
                              <p className="text-sm text-gray-500 dark:text-gray-400">
                                @{r.receiver.username}
                              </p>
                              <p className="text-xs text-amber-600 dark:text-amber-400 mt-1">
                                ממתין לתשובה · {timeAgo(r.created_at)}
                              </p>
                            </div>
                          </Link>
                        </li>

...
export async function GET(
  ...
  try {
    ...
    if (roleError) {
      console.error('Answer vote details role lookup error:', roleError);
    ...
    if (answerError) {
      console.error('Answer vote details answer lookup error:', answerError);
      return NextResponse.json(
    ...
    if (votesError) {
      console.error('Answer vote details fetch error:', votesError);
      return NextResponse.json(
    ...
    console.error('Answer vote details API error:', error);
